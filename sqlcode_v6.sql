...
INSERT INTO fact_indicators (country_id)
SELECT country_id FROM dim_country;


UPDATE fact_indicators
SET country_name = dim_country.country_name
FROM dim_country
WHERE fact_indicators.country_id = dim_country.country_id;
...
-- INSERT INTO fact_indicators (value)
...
SET country_id = dim_country.country_id
FROM dim_country
WHERE fact_indicators.country_id = fact_indicators.indicator_id;
*/
